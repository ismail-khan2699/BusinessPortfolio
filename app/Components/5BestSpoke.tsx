  ...
  return (
    ...
    <div className=' flex  pt-20'>
      <div className=' w-1/2 text-white'>
        ...
        <h3  className=' text-base w-4/6 my-5'>Lorem ipsum dolor sit amet consectetur. Blandit sodales lacus vulputate aenean aliquam accumsan vestibulum in sit Blandit sodales lacus vulputate aenean aliquam accumsa</h3>
        <a href='#' className='flexbox buttons mb-3 h-8' style={{textDecoration:'none',}}>
